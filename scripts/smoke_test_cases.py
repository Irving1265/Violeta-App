...
class VioletaSmokeTests(unittest.TestCase):
    ...
    def test_page_script_bundles_are_loaded_by_need(self):
        ...
        self.assertIn('Beta v1.1', feed_html)
        ...
        self.assertIn('20260601-sidebar-zoom-scale-v1', feed_html)
        self.assertIn('desktop-zoom-compact', feed_html)
        self.assertIn('devicePixelRatio', feed_html)
        ...
        self.assertIn('--sidebar-width: 250px', style_css)
        self.assertNotIn('--sidebar-width: 214px', style_css)
        self.assertNotIn('--sidebar-width: 178px', style_css)
        self.assertIn('Desktop zoom typography scale', style_css)
        self.assertIn('html.desktop-zoom-compact .sidebar-link i', style_css)
        self.assertIn('html.desktop-zoom-tight .sidebar-link i', style_css)
        self.assertNotIn('max-height: 820px', style_css)
        self.assertIn('font-size: 0.88rem', style_css)
        self.assertIn('font-size: 0.66rem', style_css)
        ...
        self.assertIn('20260601-compact-chat-v1', chat_html)
    ...
    def test_mobile_chat_viewport_guards_prevent_ios_zoom_and_overflow(self):
        ...
        self.assertIn('Desktop compact mode', chat_css)
        self.assertIn('max-width: 1120px', chat_css)
        self.assertIn('font-size: 0.84rem', chat_css)
    ...
    def test_pwa_manifest_service_worker_and_offline_shell(self):
        ...
        self.assertIn('Beta v1.1', offline_html)
    ...
    def test_privacy_pages_and_self_account_deletion_for_store_compliance(self):
        ...
        self.assertIn('Beta v1.1', privacy_html)
    ...
    def test_role_based_permissions_split_verification_and_safety(self):
        ...
        verification_html = verification_workspace.get_data(as_text=True)
        self.assertIn('<!DOCTYPE html>', verification_html)
        self.assertIn('admin_page.css', verification_html)
        self.assertIn('admin_page.js', verification_html)
        self.assertIn('Centro de Verificación', verification_html)
        self.assertIn('id="tab-verificaciones"', verification_html)
        self.assertNotIn('id="tab-users"', verification_html)
        self.assertNotIn('admin-activity-card', verification_html)
        ...
        safety_html = safety_workspace.get_data(as_text=True)
        self.assertIn('<!DOCTYPE html>', safety_html)
        self.assertIn('admin_page.css', safety_html)
        self.assertIn('Centro de Safety', safety_html)
        ...
        moderation_html = moderation_workspace.get_data(as_text=True)
        self.assertIn('<!DOCTYPE html>', moderation_html)
        self.assertIn('admin_page.css', moderation_html)
        self.assertIn('Centro de Moderación', moderation_html)
        self.assertIn('id="tab-reportes"', moderation_html)
        self.assertNotIn('id="tab-users"', moderation_html)
