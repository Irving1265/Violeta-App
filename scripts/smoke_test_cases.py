...
class VioletaSmokeTests(unittest.TestCase):
    ...
    def test_page_script_bundles_are_loaded_by_need(self):
        ...
        self.assertIn('20260524-explore-header-scroll-v1', feed_html)
        self.assertIn('violeta-city-filters-section', feed_html)
        self.assertIn('Zonas seleccionadas', feed_html)
        self.assertIn('id="openAdvancedFilters"', feed_html)
        self.assertIn('id="cityChipContainer"', feed_html)
        self.assertNotIn('violeta-filters-bar', feed_html)
        self.assertNotIn('violeta-header-top', feed_html)
        ...
        self.assertIn('.violeta-city-filters-section', style_css)
        self.assertIn('.violeta-filter-header', style_css)
        self.assertIn('.violeta-filter-label', style_css)
        self.assertIn('.violeta-header.header-scrolled', style_css)
        self.assertIn('.violeta-header.header-scrolled .violeta-header-content', style_css)
