...
class VioletaSmokeTests(unittest.TestCase):
    ...
    def test_page_script_bundles_are_loaded_by_need(self):
        ...
        self.assertIn('20260601-compact-sidebar-v1', feed_html)
        ...
        self.assertIn('--sidebar-width: 214px', style_css)
        self.assertIn('--sidebar-width: 178px', style_css)
        self.assertIn('.sidebar-actions', style_css)
